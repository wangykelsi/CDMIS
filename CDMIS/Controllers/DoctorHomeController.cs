...
namespace CDMIS.Controllers
{
    ...
    public class DoctorHomeController : Controller
    {
        ...
        //编辑
        public JsonResult LabTestInfoEdit(string UserId, string VisitId, int SortNo, string LabItemType, string LabItemCode, string ExamDate, string Status, string ReportDate, string DeptCode)
        {
            var user = Session["CurrentUser"] as UserAndRole;
            var res = new JsonResult();
            /*对数据进行处理*/
        ...
        //删除
        public JsonResult LabTestInfoDelete(string UserId, string VisitId, int SortNo)
        {
            var res = new JsonResult();
            /*对数据进行处理*/
        ...
        //增加
        public JsonResult LabTestInfoDetailDelete(string UserId, string VisitId, int SortNo, string Code)
        {
            var res = new JsonResult();
            /*对数据进行处理*/
        ...
        public ActionResult DrugInfo(string UserId, string VisitId)
        {
            ...
            ViewBag.MaxOrderSubNo = DrugInfoModel.MaxSortNo;
        ...
        public DrugInfoProfileViewModel GetDrugInfoList(ref DrugInfoProfileViewModel model, string DoctorId)
        {
            ...
            if (DrugRecordListds.Tables.Count != 0)
            {
                ...
                foreach (DataRow dr in DrugRecordListdt.Rows)
                {
                    ...
                    list.Add(item);
                    max = Convert.ToInt32(dr["OrderSubNo"]);
                }
